...
const App = () => {
  ...
  const API_KEY = "65b5406f81721a3a308282e6d90b5773"
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-r from-purple-600 to-pink-600 from-green-950 to-black text-white">
      {/* Serch bar and icon */}
